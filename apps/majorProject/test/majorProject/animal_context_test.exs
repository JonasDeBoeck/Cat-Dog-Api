defmodule MajorProject.AnimalContextTest do
  use MajorProject.DataCase
  ...
  describe "animals" do
    ...
    @valid_attrs %{animal_id: 42, date_of_birth: ~D[2010-04-17], name: "some name", type: "some type"}
    @update_attrs %{animal_id: 43, date_of_birth: ~D[2011-05-18], name: "some updated name", type: "some updated type"}
    @invalid_attrs %{animal_id: nil, date_of_birth: nil, name: nil, type: nil}
